...
export default class Supplayer extends React.Component{
    render(){
        return(
    ...
    <div>
        <div className="row">
            <div className="bg col-sm-3  ">
                ...
                <ul>
                    <li className='mar'>SUPPLAYER</li>
                    <li className='mar1'>Home</li>
                    <li className='mar1'>Products</li>
                    
                    <li className='mar1'>Stack details</li>
                    <li className='mar1'>Delivary details</li>
                    <li className='mar3'>
